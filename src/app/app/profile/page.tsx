  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="hidden md:flex min-h-screen">
        {/* Sidebar */}
        <aside className="w-[320px] bg-[#14141B] text-white flex flex-col justify-between rounded-[32px] m-[24px]">
        ...
        <main className="flex-1 pr-[32px] pt-[32px]">
          ...
          <div className="mt-[24px] grid grid-cols-[420px_1fr] gap-[20px]">
            ...
            <section className="bg-white rounded-[24px] border border-[#EAEAEA] shadow-sm p-[20px]">
              ...
              <div className="mt-[16px] grid grid-cols-2 gap-[14px] text-[14px]" style={{ fontFamily: "Satoshi, sans-serif" }}>
                <div>
                  ...
                  <div className="text-black">{parent?.mobile_no || "-"}</div>
                </div>
                <div>
                  <div className="text-[#9B9B9B]">Alternate Number</div>
                  <div className="text-black">{parent?.alternative_mobile || "-"}</div>
                </div>
                <div className="col-span-2">
                  <div className="text-[#9B9B9B]">Email</div>
                  <div className="text-black">{parent?.email || "-"}</div>
                </div>
              </div>
            ...
            <section className="bg-white rounded-[24px] border border-[#EAEAEA] shadow-sm p-[20px]">
                  ...
                  <div key={s.id} className="border border-[#E8B600] rounded-[16px] p-[16px]">
                    ...
                    <div className="mt-[12px] grid grid-cols-2 gap-[10px] text-[12px]" style={{ fontFamily: "Satoshi, sans-serif" }}>
                      <div>
                        ...
                        <div className="text-black">{`${s.class_name} ${s.division}`}</div>
                      </div>
                      <div>
                        <div className="text-[#9B9B9B]">School</div>
                        <div className="text-black">{schoolNameById.get(s.school_id) || `School ${s.school_id}`}</div>
                      </div>
                      <div className="col-span-2">
                        <div className="text-[#9B9B9B]">Address</div>
                        <div className="text-black">{s.student_address}</div>
                      </div>
                      <div>
                    ...
                    <button className="mt-[14px] w-full h-[44px] rounded-[22px] bg-[#E8B600] text-white font-bold" style={{ fontFamily: "Satoshi, sans-serif" }}>
                      Edit
                    </button>
                  </div>
                ))}
              ...
              <button className="mt-[16px] w-full h-[52px] rounded-[26px] bg-[#E8B600] text-white font-bold" style={{ fontFamily: "Satoshi, sans-serif" }}>
                Add Another Student
              </button>
            </section>
          </div>
