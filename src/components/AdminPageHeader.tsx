...
const ADMIN_TITLES: Record<string, string> = {
  "/admin/dashboard": "Urgent Tasks",
  "/admin/dashboard/students": "Students",
  "/admin/dashboard/fleet": "Fleet",
  "/admin/dashboard/track-bus": "Track Bus",
  "/admin/dashboard/settings": "Settings",
};

export default function AdminPageHeader({}: { onMenuClick?: () => void }) {
  ...
  return (
    <>
      <header className="w-full bg-[#19191F] px-4            py-4 flex items-center justify-between max-w-md mx-auto">
        <span className="text-white text-[20px] font-semibold font-spartan">
          {title}
        </span>
